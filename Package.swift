...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "JooycarMobilitySDK",
            url: "https://mobility-sdk.jooycar.net/ios/JooycarMobilitySDK-1.0.0-beta17.xcframework.zip",
            checksum: "706be6c39bb5a715ffa448933e5b92019c21729974bad661137fbee6892ad0cf"
        ),
        .target(
