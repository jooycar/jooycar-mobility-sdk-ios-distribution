...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "JooycarMobilitySDK",
            url: "https://mobility-sdk.jooycar.net/ios/JooycarMobilitySDK-1.0.0-beta20.xcframework.zip",
            checksum: "70424caa0799b64f226e39f39b8ce87191da141acf2665e551c37435f1bce91f"
        ),
        .target(
