...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "JooycarMobilitySDK",
            url: "https://mobility-sdk.jooycar.net/ios/JooycarMobilitySDK-1.0.1.xcframework.zip",
            checksum: "d37c27097e090a5a67a12c7a12a0a251fe537772f3539914c10be9832eb8e8d1"
        ),
        .target(
