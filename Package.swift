...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "JooycarMobilitySDK",
            url: "https://mobility-sdk.jooycar.net/ios/JooycarMobilitySDK-1.0.11.xcframework.zip",
            checksum: "91bb2630ba189d6cd7d2d2925eb33a9de6ec6435ede6ba1abe721e7097252361"
        ),
        .target(
