...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "JooycarMobilitySDK",
            url: "https://mobility-sdk.jooycar.net/ios/JooycarMobilitySDK-1.0.0-beta23.xcframework.zip",
            checksum: "de12976b6039d7c8262976908bc2e6b1c5eeaf6b76f0736d9552eeb88937ca64"
        ),
        .target(
