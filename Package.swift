...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "JooycarMobilitySDK",
            url: "https://mobility-sdk.jooycar.net/ios/JooycarMobilitySDK-1.0.10.xcframework.zip",
            checksum: "477535b1028ad3d4337415098963c983fdbd0888f73b1942449984d5fcda9024"
        ),
        .target(
